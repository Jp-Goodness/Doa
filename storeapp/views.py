...
class CategoryView(View):
    def get(self, request, val):
        ...
        return render(request, 'storeapp/category.html', locals())
...
class ProductDetail(View):
    def get(self, request, pk):
        ...
        return render(request, 'storeapp/productdetail.html', locals())

class CustomerRegistrationView(View):
    def get(self, request):
        form = CustomerRegistrationForm()
        return render(request, 'storeapp/customerregistration.html', {'form': form})
...
class ProfileView(View):
    def get(self, request):
        ...
        return render(request, 'storeapp/profile.html', locals())
    def post(self, request):
        ...
        if form.is_valid():
            ...
            reg.save()
            messages.success(request, 'Your profile details has been saved successfully.')
        else:
            messages.warning(request, 'Invalid input data')
        return render(request, 'storeapp/profile.html', locals())
...
def address(request):
    ...
    return render(request, 'storeapp/address.html', locals())

class updateAddress(View):
    def get(self, request, pk):
        add = Customer.objects.get(pk=pk)
        form = CustomerProfileForm(instance=add)
        return render(request, 'storeapp/updateAddress.html', locals())
...
def show_cart(request):
    ...
    return render(request, 'storeapp/addtocart.html', locals())
